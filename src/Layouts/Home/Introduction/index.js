					...
					<div className='home__introduction--content ' ref={contentRef}>
						<div className='panel-text creative'>
							<div className='mb-16 sm:mb-28'>
								...
								<p>
								اینجا کدآموز است.جایی برای یادگیری برنامه نویسی و توسعه نرم‌افزار به زبان فارسی با امکان تمرین و رفع اشکال و کلی فعالیت هیجان انگیز. اینجا کمکتون می‌کنیم به عنوان یه برنامه‌نویس حرفه‌ای، شروع به کار کنید.
در «کدآموز» سعی داریم برای علاقه‌مندان به دنیای توسعه نرم‌افزار و برنامه‌نویسی، فضایی برای یادگیری به زبان فارسی و امکان پیشرفت را فراهم کنیم.
 در «کدآموز» دوره‌های آموزشی جامع و کاملی به زبان فارسی ارائه می‌کنیم که به شما امکان دهد به عنوان یک برنامه‌نویس حرفه‌ای شروع به کار کنید و یا مهارت‌های خود را توسعه بخشید.
						...
						<div className='panel-text website'>
							<div className='mb-16 sm:mb-28'>
								<h3 className='mb-10'>
								فهرستی جامع از وب سایت‌های مناسب برای مطالعه بیشتر مرتبط با برنامه نویسی
