      ...
      <div className="card-bg-info">
        <div className="card-bg-content ">
          <div className="d-flex-space MyCourses__Card--header">
            ...
            <BtnLink>مشاهده ی کل دوره</BtnLink>
          </div>
            ...
            {!finishedCourse ? (
              ...
              <>
                <div className='d-flex-align'>
                  ...
                  <p className="MyCourses__Card--body-p mx-4 ">دوره تکمیل شده </p>
                </div>
                <Link className="MyCourses__Card--Link ">
                  {" "}
          ...
          <div className="d-flex-space card-bg-footer">
            ...
            <Link className="MyCourses__Card--Link"> ارتباط با استاد</Link>
          </div>
        </div>
      </div>
    </article>
