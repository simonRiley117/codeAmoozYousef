...
import UseScrollTeacherTable from "./UseScrollTeacherTable";
import Button from "@Components/Shared/Buttons/Button";
import { Tag } from "antd";

function TeacherInfo() {
  const { sticky, stickydisable } = UseScrollTeacherTable();
    ...
    >
      ...
      >
        ...
        <p className="TeacherInfo__description leading-9 text-justify">
          {" "}
          ایپسوم متن ساختگی با تولید ایپسوم متن ساختگی با تولید سادگی نامفهوم از
          لازم است، و برای شرایط فعلی تکنولوژی مورد سادگی نامفهوم از لازم است، و
