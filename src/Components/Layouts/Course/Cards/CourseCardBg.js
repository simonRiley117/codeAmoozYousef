...
const CourseCardBg = ({card}) => {
    ...
    const [isFav, setIsFav] = useState(favoriteCourseListIcons.find(element => element === uuid))
    const [isInCart, setIsInCart] = useState(cartCourseListIcons.find(element => element === uuid))
    useEffect(() => {
