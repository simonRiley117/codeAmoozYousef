            ...
            {getAboutCourse?.response
                ?<div>
                    ...
                    {properties.map(property => (
                        <p key={property.id} className="AboutDetaile__txt leading-loose About__list">
                            {property.prop}
                        </p>
                    ))}
                    ...
                    {prerequisites.map(prerequisite => (
                        <p key={prerequisite.id} className="AboutDetaile__txt leading-loose About__list">
