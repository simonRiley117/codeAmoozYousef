  ...
  const ChangepassRequest = useFetch({
    ...
    argErrFunc: (mess) => {
      ...
      if ("new_password1" in mess)
        ...
        } else if (mess.new_password1.includes("This password is too common.")) {
  ...
  return (
    <div className="ChangePassword layout">
      <header className="layout__header">
       ...
       <form onSubmit={handleSubmit(onSubmit)} className="ChangePassword__form primary-box">
        ...
        />
         ...
         <Button
          disabled={ChangepassRequest.loading}
          htmlType="submit"
        >
          {loading ? (
            <DotLoader
