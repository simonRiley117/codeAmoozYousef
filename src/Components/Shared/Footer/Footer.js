...
import back from '@Assets/Pic/Group 846.png';
import neshan from '@Assets/Pic/Group.png';
import enamad from '@Assets/Pic/Group (1).png';
			...
			<div className='flex items-center absolute Footer__content'>
				<div className='Footer__AboutUsBox flex flex-col  p-16'>
					...
					<p className='Footer__AboutUsBox-text text-center text-2xl font-medium leading-8	'>
						Lorem ipsum dolor sit amet, exerci legere percipitur his ex.
						Te dolor delectus necessitatibus qui. Usu tantas officiis ea.
						Et per oratio nusquam menandri, mel ex esse inani graece. Dico
						case id nec. Et nec soluta molestiae accommodare.
					</p>
				</div>
