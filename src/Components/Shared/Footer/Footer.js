      ...
      <div className="container">
        <div className="footer__wrapper  pt-24 ">
          ...
          <section className="footer__link ">
            ...
            // <Link to="/faq">قوانین و مقررات</Link>
        ...
        <section className="footer__social flex justify-end gap-x-7">
          ...
          <a target='_blank' href="https://www.instagram.com/codeamooz_co?igsh=YnVnbXFmc3hpbjl">
            <span className="footer__social--item">
              <InstagramIcon />
            </span>
          </a>
          <a target='_blank' href="https://www.linkedin.com/company/codeamooz/">
            <span className="footer__social--item">
              <LinkedInIcon />
            </span>
          </a>
